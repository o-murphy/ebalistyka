...
class TrajectoryTable extends StatelessWidget {
  const TrajectoryTable({
    required this.tableData,     // FormattedTableData from ViewModel
    required this.spoilerData,   // TablesSpoilerData from ViewModel
  });
...
lib/screens/shot_info_screen.dart          ← will be ShotInfoViewModel
```
