...
export class CircularSliderLegacy extends React.Component<
...
export class CircularSliderWithChildren extends React.Component<
    React.PropsWithChildren<Props>
> {
    static defaultProps = CircularSliderLegacy.defaultProps;
    ...
    render() {
        ...
        return (
            ...
            >
                <CircularSliderLegacy {...this.props} />
                <div
                    style={{
                        position: "absolute",
                        top: "25%",
...
export default CircularSliderLegacy;